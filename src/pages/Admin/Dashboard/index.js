            ...
            <Row gutter={[16, 16]}>
                <Col xs={24} lg={8}>
                    <div
                        ...
                        className={cx("dashboard-item", "px-4", "py-4")}
                    >
                        <div className={cx("d-flex", "align-items-center")}>
                            <span
                                style={{ background: "#0d47f5" }}
                                className={cx("dashboard-item-icon", "me-2")}
                            >
                        ...
                        <p className={cx("d-flex", "align-items-center")}>
                            ...
                            <span className={cx("fs-12", "font-primary")}>
                                9.0%
                            </span>
                        </p>
                    </div>
